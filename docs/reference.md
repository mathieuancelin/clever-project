# clever-project — Reference

Complete reference for every command, flag, and file format. For a quick overview and getting started, see the [README](../README.md).

## Table of contents

- [Project file lookup](#project-file-lookup)
- [Commands](#commands)
  - [`init`](#init)
  - [`apply`](#apply)
  - [`delete`](#delete)
...
- [Managed addons (env and domains)](#managed-addons-env-and-domains)
- [Display block](#display-block)
- [Variables](#variables)
- [Secrets](#secrets)
- [Hooks](#hooks)
- [State file](#state-file)
- [Machine-readable output (`--format json`)](#machine-readable-output---format-json)
- [Behaviour notes / limitations](#behaviour-notes--limitations)
